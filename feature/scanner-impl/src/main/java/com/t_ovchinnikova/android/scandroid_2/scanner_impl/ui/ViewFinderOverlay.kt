...
class ViewFinderOverlay(
    ...
    companion object {
        ...
        val BACKGROUND_RECTICLE_DEFAULT_COLOR = R.color.barcode_recticle_background
        const val STROKE_DEFAULT_COLOR = Color.WHITE

        val STROKE_BOX_WIDTH_DEFAULT = R.dimen.barcode_stroke_width
        val BOX_CORNER_RADIUS_DEFAULT = R.dimen.barcode_recticle_corner_radius
    }
}